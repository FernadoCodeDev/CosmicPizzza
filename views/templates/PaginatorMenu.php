<div id="appMenu" class="StepsMenu">
    <nav class="tabsMenu">
        <!--PAGINADOR-->
    ...
    <!-- DIV para Promociones -->
<div id="stepMenu-1" class="seccionMenu ShowMenu">
    <h2>Promoción</h2>
        ...
        <?php if (isset($product) && !empty($product)) { ?>
            <?php foreach ($product as $producto) { ?>
                <?php if ($producto->tipo === 'promocion') : ?>
                    <div class="anuncio">
                        <img src="Image/Fondo-Anuncio.png" alt="<?php echo htmlspecialchars($producto->nombre); ?>">
...
<!-- DIV para Pizzas -->
<div id="stepMenu-2" class="seccionMenu">
    <h2>Pizza</h2>
    <div class="contenedor-anuncios">
        <?php if (isset($product) && !empty($product)) { ?>
            <?php foreach ($product as $producto) { ?>
...
<div id="stepMenu-3" class="seccionMenu">
    <h2>Complementos</h2>
    <div class="contenedor-anuncios">
        <?php if (isset($product) && !empty($product)) { ?>
            <?php foreach ($product as $producto) { ?>
...
<!-- DIV para Postres -->
<div id="stepMenu-4" class="seccionMenu">
    <h2>Postres</h2>
    <div class="contenedor-anuncios">
        <?php if (isset($product) && !empty($product)) { ?>
            <?php foreach ($product as $producto) { ?>
...
<script>
    ...
    const tabsMenu = () => {
        const buttons = document.querySelectorAll('.tabsMenu button');
        buttons.forEach(bt => {
